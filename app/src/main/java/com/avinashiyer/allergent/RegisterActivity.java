    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb_login.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                // App code
                Log.d("On success called",loginResult.getAccessToken().getUserId());
                ...
                GraphRequest request = GraphRequest.newMeRequest
                        (loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                            ...
                            public void onCompleted(JSONObject object, GraphResponse response) {
                                // Application code
                                Log.d("On facebook login", response.toString());
...
//        mSpinner = (MaterialSpinner)findViewById(R.id.allergieSpinner);
//        String[] ITEMS = {"Milk", "Eggs", "Peanuts", "Tree Nuts", "Soy", "Wheat","Fish","Gelatin","Meat","Spices"};
...
//        mSpinner.setAdapter(adapter);
    ...
    private void generateHashKey(){
        PackageInfo info;
        try {
            info = getPackageManager().getPackageInfo("com.avinashiyer.allergent", PackageManager.GET_SIGNATURES);
