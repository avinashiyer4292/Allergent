...
public class AllergiesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_allergies, container, false);
        listview = (ListView)v.findViewById(R.id.allergiesListView);
        prefs = this.getActivity().getSharedPreferences(Constants.SHARED_PREFS,Context.MODE_PRIVATE);
